...
public class FullStackEngineer extends Developer {

    protected String mainFramework;

    public FullStackEngineer(String name, int age, String email, String language, String framework) {
    ...
    @Override
    public void toWork() {
        System.out.println("풀스택 개발자가 백엔드와 프론트엔드 개발을 합니다.");
    }
}
